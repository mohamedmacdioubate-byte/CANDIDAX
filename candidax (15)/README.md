...
Crée un projet sur [supabase.com](https://supabase.com), puis dans **SQL Editor → New query**, exécute **les 8 scripts ci-dessous, dans cet ordre exact** (un script à la fois, `Run`, attendre "Success" avant de passer au suivant) :
...
8. `supabase-schema-8-language.sql` — langue préférée (choisie selon le pays à l'inscription, modifiable ensuite)
